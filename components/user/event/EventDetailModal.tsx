    ...
    >
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            "fixed top-14 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-3rem)] max-w-sm max-h-[85vh] rounded-[24px] bg-gomin-primary-100 overflow-y-auto scrollbar-hide shadow-xl outline-none",
            "animate-slide-down"
          )}
        >
          <DialogClose asChild>
