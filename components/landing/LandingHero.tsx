        ...
        <div className="w-full">
          <div className="grid grid-cols-[1.05fr_0.95fr] gap-14 items-center max-lg:grid-cols-1 max-lg:gap-10">
            <div className="flex flex-col gap-5">
              <h1 className="font-extrabold text-[clamp(24px,4.8vw,56px)] leading-[1.2] tracking-tight font-nanum break-keep word-keep-all animate-fade-up">
                누구나 쉽게
                <br /> 시작하는 스탬프 투어
              </h1>
              ...
              <p className="text-[clamp(14px,1.5vw,18px)] text-gomin-neutral-600 leading-[1.62] break-keep word-keep-all animate-fade-up-delay-2">
                행사의 몰입도를 위해 스탬프 투어는 이제 필수.
                <br />
                간편하게 내 행사에 스탬프 투어를 적용해 보세요.
              </p>
              <div className="flex gap-3.5 flex-wrap animate-fade-up-delay-2">
                <a
                  href="/admin"
